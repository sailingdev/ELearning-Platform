...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    audioControl: function audioControl() {
      ...
      if (audio) {
        if (this.isPlayable) audio.play();else {
          audio.pause();
          audio.currentTime = 0;
        }
      }
  ...
  computed: {
    translated3d: function translated3d() {
      var val = -610 * this.currentSlide;
      return "translate3d(".concat(val, "px, 0px, 0px)");
    },
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "min-height-container lesson-position" }, [
    _vm._m(0),
    _vm._v(" "),
    _vm._m(1),
    _vm._v(" "),
    ...
    _vm._v(" "),
    _c("div", { attrs: { id: "slide-modal-body" } }, [
      _c("div", { staticClass: "html-lesson-content" }, [
        ...
        _c(
          "div",
          {
            staticClass: "start-overlay",
            style: { display: _vm.startOverlayBtn }
          },
          [
            _c(
              "button",
              {
                staticClass: " start-icon-wrapper",
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "social-media-share" }, [
      _c("div", { staticClass: "share-closed" }, [
        _c("i", { staticClass: "icon-share" })
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "share-open" }, [
        _c("div", { staticClass: "share-email" }, [
          _c("i", { staticClass: "icon-mail-alt" })
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "share-facebook" }, [
          _c("i", { staticClass: "icon-facebook" })
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "share-cancel" }, [
                  ...
                  [
                    ...
                    _c("div", { staticClass: "card-background intro-slide" }, [
                      ...
                      _c(
                        ...
                        {
                          staticClass: "intro-section",
                          staticStyle: { padding: "20px 104px 16px" }
                        },
                        [
                          _c(
                            "div",

                ...
                <div id="slide-view">
                    ...
                    <div id="lesson-carousel" style="" class="slick-initialized slick-slider">
                        <button class="slick-prev slick-arrow lni-arrow-left lni-bold" aria-label="Previous"
                                type="button" aria-disabled="true" :style="{display: previousBtn}" @click="direction(false)"
                        >
                        </button>
                        <div class="slick-list draggable" style="padding: 0px 20px;">
                            <div class="slick-track"
                                ...
                                <the-listening-review :listen-score="listenScore" @playAgain="playAgain" />
                            </div>
                        </div>
                        <button class="slick-next slick-arrow lni-arrow-right lni-bold" aria-label="Previous"
                                      type="button" aria-disabled="true" :style="{display:nextBtn}" @click="direction(true)"
                        >
                        </button>
                    </div>
                    <div id="slide-footer">
      ...
      methods: {
          ...
          review(id){
             let realId = this.dataList[this.currentSlide].id
              ...
              id === realId ? this.listenScore.right += 1 : this.listenScore.wrong += 1
              this.listenScore.score = Math.round(this.listenScore.right * 100 / this.dataList.length)
